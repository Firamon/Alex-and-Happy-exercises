...
happyExpList = Happy_Data_Array.listArray (0,40) ([528,2,28672,8448,960,32900,4112,2,512,64,49185,33801,18176,528,28,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_calc","Exp","int","'+'","'-'","'*'","\"==\"","if","then","else","%eof"]
        bit_start = st * 13
        bit_end = (st + 1) * 13
...
action_15 (6) = happyShift action_6
...
action_17 (7) = happyShift action_7
...
happyReduction_2 ((HappyAbsSyn4  happy_var_8) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (fun happy_var_2 happy_var_4 happy_var_6 happy_var_8
	) `HappyStk` happyRest
